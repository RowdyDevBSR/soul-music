...
client.on('guildCreate', async (guild) => {
    ...
    client.channels.cache.get("933714848376840212").send({embeds: [embed]})
  ...
  try {
    ...
    const texts = "Hi, This Is Jazz If You Need Support Related Me Join My Support Server. Support Server Link Is Here https://discord.gg/2UXm5UnvBd"
